...
def build(image_set, args):
    ...
    mode = 'instances'
    PATHS = {
        "train": ('/data/jianhonghan/遥感域适应数据集/DOTA1.0/crop_800_100_3c/val/train_images',
                '/data/jianhonghan/遥感域适应数据集/DOTA1.0/crop_800_100_3c/annotations/val_3c.json'),
        "val": ('/data/jianhonghan/遥感域适应数据集/DOTA1.0/crop_800_100_3c/val/train_images',
                '/data/jianhonghan/遥感域适应数据集/DOTA1.0/crop_800_100_3c/annotations/val_3c.json'),
    }
